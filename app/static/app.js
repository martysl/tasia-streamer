...
function providerName(p){return ({auto:'Auto / All Sources + Local',all:'All Sources',universal:'Universal Search',soundcloud:'SoundCloud Search',audius:'Audius',jamendo:'Jamendo',stremio:'Stremio Addon','btch-spotify':'Spotify · SpotiFLAC','btch-soundcloud':'SoundCloud · Tioo','btch-gdrive':'Google Drive',suno:'Suno',direct:'Direct audio',jellyfin:'Jellyfin',webdav:'WebDAV',ftp:'FTP / FTPS',local:'Local library'})[p]||p;}
function providerShort(p){return ({universal:'UNIV',soundcloud:'SC',audius:'AUDIUS',jamendo:'JAM',stremio:'STREMIO','btch-spotify':'SPOT','btch-soundcloud':'SC','btch-gdrive':'GDRIVE',suno:'SUNO',direct:'URL',jellyfin:'JELLY',webdav:'DAV',ftp:'FTP',local:'LOCAL'})[String(p||'').toLowerCase()]||String(p||'').slice(0,8).toUpperCase();}
